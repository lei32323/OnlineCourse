...
<div class="left180">
 ...
 <div class="display">
<form action="<%=contextPath %>/updpwd" method="post">
 ...
 <tr>
 <td>&nbsp;&nbsp;&nbsp;<b>当前密码:</b></td><td>&nbsp;&nbsp;&nbsp;<input type="password" class="input1"  name="oldpwd"/></td>
 </tr>
 <tr>
 <td>&nbsp;&nbsp;&nbsp;<b>新密码:</b></td><td>&nbsp;&nbsp;&nbsp;<input type="password" class="input1"  name="pwd"/>&nbsp;&nbsp;&nbsp;</td>
 </tr>
  <tr>
<!--  <td></td><td>&nbsp;&nbsp;&nbsp;&nbsp;密码强度：&nbsp;&nbsp;弱&nbsp;&nbsp;<img src="images/grzx/password.jpg" />&nbsp;&nbsp;强</td> -->
 </tr>
<tr>
 <td>&nbsp;&nbsp;&nbsp;<b>确认新密码:</b></td><td>&nbsp;&nbsp;&nbsp;<input type="password" class="input1"  name="pwdr"/>&nbsp;&nbsp;&nbsp;</td>
 </tr>

    <tr>
<!--   <td>&nbsp;&nbsp;&nbsp;<b>验证码:</b></td><td>&nbsp;&nbsp;&nbsp;<input type="text" class="input4" style="width:100px; height:35px;" />&nbsp;&nbsp;&nbsp;<a href="#">看不清切换一下</a></td> -->
 </tr>
<%--  <tr><td></td><td>&nbsp;&nbsp;&nbsp;<img src="<%=contextStatic %>/images/grzx/yzm.jpg" /></td></tr> --%>
