...
<div id="container">
  <div class="kcjs">
    <div class="left750">
      <div class="dxlogo"><a href="#"><img src="<%=contextStatic %>/images/home/dxlogo.jpg" /></a></div>
      <!--教程简介-->
      <div class="dxinfo">
        <h1>${course.name }</h1>
<!--         <p>别再让人说你学的是“哑巴英语”了！如果你想用英语跟外国友人零障碍问候聊天、讨论交流、甚至是辩驳其误解，就行动起来吧。我们的课程广泛满足了海外旅游、外企工作和留学考试的现实需求，迎合新一代大学生的兴趣点和思维特点，从现在起跟我们一起学习，你将得到一门终身受益的本领。</p> -->
     ...
     <div class="right250">
      ...
      <ul class="list">
        <li>
          <div class="lsimg"><img src="${course.teacher.userinfo.headAddress }" /></div>
  ...
  <div class="kcms">
    <div class="left248">
      <div style="margin-bottom:20px;"><a href="#"><img src="<%=contextStatic %>/images/home/ad.jpg" /></a></div>
      <!--导航-->
      <div class="menu">
        <ul>
         <li><a href="<%=contextPath %>/tocourseforuser?id=${course.id}" >课程介绍</a></li>
          <li><a href="<%=contextPath %>/tocoursestudy?courseId=${course.id}" >课程学习</a></li>
        </ul>
      </div>
    </div>
    <div class="right735">
    <form action="<%=contextPath %>/tocoursestudy" method="post" id="moodform">
      ...
      <div class="zxsc">
        ...
        <c:forEach items="${page.list }" var="video" varStatus="vs">
          <li class="myvideo">
            <div class="myvideoimg"><img src="<%=contextPath %>/${video.fengmian}" width="200px" height="118px"/>
              <h3><a href="<%=contextPath %>/tolookvideo?courseId=${video.courseId}&id=${video.id}">${video.name }</a></h3>
              <span class="play1"><a href="<%=contextPath %>/tolookvideo?courseId=${video.courseId}&id=${video.id}" title="播放">播放</a></span></div>
            <div class="title6"> <b>主讲：</b>${course.teacher.name } </div>
          </li>
          </c:forEach>
        </ul>
      </div>
