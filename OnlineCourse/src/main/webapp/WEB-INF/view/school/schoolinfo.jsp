...
<script type="<%=contextStatic %>/text/javascript" src="script/jquery.min.js"></script>
...
<div id="container">
  <div class="left180">
    ...
    <ul class="menu3">
      <li><a href="<%=contextPath %>/tocourselist"><em>课程管理</em></a></li>
    </ul>
    <ul class="menu4">
  ...
  <div class="right740">
    <div class="title10">
      <h1><a href="<%=contextPath %>/toschoolinfo" class="on">信息编辑</a></h1>
<%--       <h1><a href="<%=contextPath %>/toupdpwd">密码修改</a></h1> --%>
    </div>
    <div class="display">
     	<form method="post" action="<%=contextPath %>/schoolinfo" enctype="multipart/form-data" >
     	<input  type="hidden" value="${school.id }" name="id"/>
     		 <table width="840" height="400" align="center" cellspacing="0" cellpadding="0" class="tab">
        <tr>
          <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>高校名称:</b></td>
          <td>&nbsp;&nbsp;&nbsp;
            <input type="text" class="input1" style="color: black"  name="schoolName" value="${school.schoolName }"/></td>
        </tr>
        <tr>
          <td valign="top"><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>高校LOGO:</b></td>
          <td><table cellpadding="0" cellspacing="0">
              <tr>
                <td>&nbsp;&nbsp;&nbsp;
                  <input type="file" class="input1"  name="file" style="color: black"/>
<!--                   &nbsp;&nbsp;&nbsp;<font class="f_black">仅支持jpg,png,gif,且文件小于5M</font> -->
				</td>
              </tr>
<!--               <tr> -->
<%--                 <td class="gxtx"><img src="<%=contextStatic %>/images/grzx/gxlogo.jpg" /></td> --%>
<!--               </tr> -->
            </table></td>
        </tr>
        <tr>
          <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>高校介绍:</b></td>
          <td>&nbsp;&nbsp;&nbsp;
            <textarea class="input4" style="width:435px; height:128px;color: black" name="schoolProfile">${school.schoolProfile }</textarea></td>
        </tr>
        <tr>
          <td></td>
          <td colspan="2">&nbsp;&nbsp;&nbsp;
            <input type="submit" value="保存信息" class="btn1" /></td>
        </tr>
      </table>
     	</form>
    </div>
