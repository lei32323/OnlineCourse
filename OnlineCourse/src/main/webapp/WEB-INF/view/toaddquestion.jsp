...
<form action="<%=contextPath %>/addquestion" method="post">
	  <div class="display">
	    <div class="title14">
	      <h1>一句话描述您的疑问</h1>
	      <h2><a href="#">2480</a> 位老师 <a href="#">12797364</a> 位目友为您在线解答</h2>
	    </div>
	    <textarea name="doubt" class="input4" style="width:838px; height:340px;"></textarea>
