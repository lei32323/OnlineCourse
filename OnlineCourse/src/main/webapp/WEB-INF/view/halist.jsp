  ...
  <div class="left180">
    ...
    <ul class="menu4">
      ...
      <div class="menubox">
        ...
        <p><a href="<%=contextPath %>/toaddquestion" style="color:#e10083">我的提问</a></p>
...
<div class="right840">
  <div class="title11">
    <h1><a href="<%=contextPath %>/toaddquestion" class="on">我的提问</a></h1>
   	<h1><a href="<%=contextPath %>/questionlist" >已提问问题</a></h1>
  </div>
  <div class="detail">
  <!--提交回答-->
    <div class="title18"><h2>${tabQuestions.doubt }</h2></div>
<!-- 	<div class="titleinfo"><a href="#">王老师</a> </div> -->
<%-- 	<div style="margin:15px 0px;"><img src="<%=contextStatic %>/images/grzx/twform.jpg" /></div> --%>
<!--     <input type="submit" value="提交问题" class="input13" style="float:right"/> -->
	<div class="clear"></div>
	<c:forEach items="${tabQuestions.questionsAnswers }" var="answer">
		<!--相关回答-->
		<div class="requir">
		<div class="title19"><div class="hfts">回答</div><div class="paixu"></div><div class="hfjb"><fmt:formatDate value="${answer.answerDate }" pattern="yyyy-MM-dd" /> </div></div>
		<div class="hfhd"><div class="hfname"><a href="<%=contextPath %>/touserinfo?userId=${answer.answerUserid }" class="on">${answer.answerName }</a> </div>
		<div class="clear"></div>
		<!--回答内容-->
		<div class="hfnr" style="word-wrap: break-word">${answer.answerContent }</div>
		<!--追问-->
	<!-- 	<div class="zhuiwen"><span class="zwen">追问</span><span class="zwnr">您好 请问 如无法选填请修改个人计算机的浏览器设置 是怎么回事啊</span></div> -->
		<div class="clear"></div>
		<!--评论-->
<!-- 		<div class="pinlun"><div class="plfl"><span class="wypl"><a href="#">评论</a></span><span class="zan"><a href="#">0</a></span><span class="xu"><a href="#">0</a></span></div></div> -->
<!-- 		<div class="clear"></div> -->
		<!--写下评论-->
		</div>
	  </div>
	</c:forEach>
	<form method="post" action="<%=contextPath %>/addanswers" id="answersform">
		<input type="hidden" name="answerContent" id="answerContent"/>
		<input type="hidden" name="answerId" value="${tabQuestions.id }"/>
		<div class="requir">
			<div class="xxpl">
			<input type="text" class="input16" id="answerContentinput"  value="写下你的评论..." onFocus="if(this.value=='写下你的评论...'){this.value=''};" onBlur="if(this.value==''){this.value='写下你的评论...';}"/>
			<div class="button"><input type="reset" value="取消" class="input17" /><input type="button" value="发布" id="addbtn" class="input18" /></div>
			</div>
		</div>
	</form>
</div>
...
<script>
	$("#addbtn").click(function(){
		$("#answerContent").val($("#answerContentinput").val());
		$("#answersform").submit();
	})
</script>
<script>
