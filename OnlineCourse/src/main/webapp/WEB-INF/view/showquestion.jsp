...
<!--     <input type="submit" value="提交问题" class="input13" style="float:right"/> -->
	...
	<!-- 	<div class="clear"></div> -->
		<!--写下评论-->
	<!-- 	<div class="xxpl"> -->
	<!-- 	<input type="text" class="input16"  value="写下你的评论..." onFocus="this.value='';" onBlur="if(this.value==''){this.value='写下你的评论...';}"/> -->
	<!-- 	<div class="button"><input type="reset" value="取消" class="input17" /><input type="submit" value="发布" class="input18" /></div> -->
	<!-- 	</div> -->
		</div>
	  </div>
	</c:forEach>
