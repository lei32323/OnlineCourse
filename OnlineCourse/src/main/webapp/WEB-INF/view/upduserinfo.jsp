...
<div class="subbox">
  ...
  <div class="left180">
    ...
    <ul class="menu1">
      ...
      <div class="menubox">
       <p ><a href="<%=contextPath %>/userinfo" style="color:#e10083">信息完善</a></p>
  ...
  <div class="right840">
    <div class="title6">
      <h1><a href="<%=contextPath %>/userinfo" class="on">信息完善</a></h1>
      <h1><a href="<%=contextPath %>/phouserinfo">修改图像</a></h1>
      <h1><a href="<%=contextPath %>/topwduserinfo">账户安全</a></h1>
    </div>
    <form action="<%=contextPath %>/wsuserinfo" method="post">
   		 <input type="hidden" name="id" value="${user.id }"/>
    	<div class="display">
      <table width="840" height="900" align="center" cellspacing="0" cellpadding="0" class="tab">
        <tr>
          <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>用户名:</b></td>
          <td>&nbsp;&nbsp;&nbsp;<input type="text" class="input1"  name="loginName" value="${user.loginName }"/>&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
          <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>邮 箱:</b></td>
          <td>&nbsp;&nbsp;&nbsp;<input type="text" class="input1"  name="email" value="${user.email }"/>&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
          <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>手 机:</b></td>
          <td>&nbsp;&nbsp;&nbsp;
            <input type="text" class="input1"  name="phone" value="${user.phone }"/>
           </td>
        </tr>
        <tr>
          <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>QQ号:</b></td>
          <td>&nbsp;&nbsp;&nbsp;
            <input type="text" class="input1"  name="qq" value="${user.qq }"/>
           </td>
        </tr>
        <tr>
          <td>&nbsp;&nbsp;&nbsp;<b>兴趣爱好:</b></td>
          <td>&nbsp;&nbsp;&nbsp;
            <textarea name="hobby" class="input4" style="width:430px; height:130px;">${user.hobby }</textarea></td>
        </tr>
        <tr>
          <td>&nbsp;&nbsp;&nbsp;<b>个人介绍:</b></td>
          <td>&nbsp;&nbsp;&nbsp;
            <textarea name="selfIntroduction" class="input4" style="width:430px; height:130px;">${user.selfIntroduction }</textarea></td>
        </tr>
        <tr>
          <td><font class="f_red">*</font>&nbsp;&nbsp;&nbsp;<b>性别:</b></td>
          <td>&nbsp;&nbsp;&nbsp;
          
            <input type="radio" name="sex" value="1" <c:if test="${user.sex==1 }">checked="true"</c:if> />
            男
            <input type="radio" name="sex" value="0" <c:if test="${usersex==0 }">checked="true"</c:if>/>
            女</td>
        </tr>
        <tr>
          <td></td>
