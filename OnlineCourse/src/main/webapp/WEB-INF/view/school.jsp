...
<div id="head">
  <div class="top">
    ...
    <div class="nav">
      <ul>
        <li class="li1"><a href="#">大学</a></li>
        <li class="li2"><a href="#">课程</a></li>
      </ul>
    </div>
    <div class="search">
    ...
    <div class="hyinfo">
      <ul>
        <li class="hy1"><a href="#" class="on"><img src="<%=contextStatic %>/images/hyimg.jpg" /></a>
          <div class="subbox"><span></span><a href="#" >我的课程</a> <a href="#" >设置</a> </div>
        </li>
...
<div class="xxjj">
  ...
  <div class="xxgk">
    <h1>中国科学技术大学</h1>
    <p>中国科学技术大学，简称“中国科大”，是中国科学院直属的一所以前沿科学和高新技术为主、兼有特色管理和人文学科的综合性全国重点大学，是国家首批7所“211工程”和首批9所“985工程”建设的大学之一，也是唯一参与中科院“知识创新工程”的大学，为中国科学院、教育部和安徽省重点共建高校，是九校联盟（C9）成员、中国大学校长联谊会成员、东亚研究型大学协会成员、环太平洋大学联盟成员，是首批“2011协同创新中心”和中科院知识创新工程重点建设院校。</p>
  </div>
</div>
<div id="container">
  <ul class="list6">
    <li>
      <div class="kcimg"><a href="#"><img src="<%=contextStatic %>/images/home/kcimg1.jpg" /></a></div>
      <div class="kcname"><a href="#">教你做MOOC</a></div>
      <div class="author"><a href="#">主讲：彭天笑、刘源源、陈菁、李淼</a></div>
      <div class="date">2014-10-25开课</div>
    </li>
    <li>
      <div class="kcimg"><a href="#"><img src="<%=contextStatic %>/images/home/kcimg1.jpg" /></a></div>
      <div class="kcname"><a href="#">教你做MOOC</a></div>
  ...
  <div class="qbschool">
    ...
    <ul class="list5">
      <li>
        <div class="lsimg"><img src="<%=contextStatic %>/images/home/lsimg.jpg" /></div>
        <div class="lsjj">
          <div class="lsname">罗先觉</div>
          <div class="lszc">教授 博士生导师</div>
        </div>
      </li>
      <li>
        <div class="lsimg"><img src="<%=contextStatic %>/images/home/lsimg.jpg" /></div>
